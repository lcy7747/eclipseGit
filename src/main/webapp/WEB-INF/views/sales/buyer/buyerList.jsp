...
// 					var name = $(this).prevAll("input[name='cl_name1']").val($("#nameText").val()).value();
				...
				$("#searchHiddenForm").on("submit",	function() {
						...
						$.ajax({
							url:"${pageContext.request.contextPath}/salesTeam/buyerManage/buyerLists",
							data : queryString,
							dataType:"json",
		...
		$("#listBody").on("click","tr",function(){
			...
			location.href="${pageContext.request.contextPath}/salesTeam/buyerManage/detailBuyer/"+cl_no;
		}).css({cursor:"pointer"});
